...
Users begin by signing up and then completing a health questionnaire covering their symptoms and relevant medical history. Based on this input, the system matches them with a suitable heathcare professional. This ensures that advice is relevant and personalised. 
...
## Rationale
The purpose of our application is to improve healthare accessbility and reduce pressure on traditional healthcare services. Our application is an easier solution for patients in rural areas and we provide faster access to medical advice for non-urgent issues. TreatMe aims to work alongside GPs to help reduce waiting times for patients. 
