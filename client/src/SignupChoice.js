  ...
  return (
    <div style={{ fontFamily: "'Segoe UI', -apple-system, sans-serif", minHeight: "100vh", backgroundColor: "#f0f4ff" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "80px 20px", textAlign: "center" }}>
        <p style={{ fontSize: "0.8rem", fontWeight: "700", color: "#3b82f6", textTransform: "uppercase", letterSpacing: "0.12em", marginBottom: "12px", opacity: 1 }}>Get started</p>
        <h1 style={{ fontSize: "2.2rem", fontWeight: "800", color: "#0f1f4b", marginBottom: "12px" }}>Join TreatMe</h1>
        ...
        <div style={{ display: "flex", gap: "24px", flexWrap: "wrap", justifyContent: "center", marginBottom: "36px" }}>
          ...
          <div style={{
            ...
            <p style={{ fontSize: "0.88rem", color: "#64748b", lineHeight: "1.6", textAlign: "center", margin: 0, opacity: 1, minHeight: "60px" }}>
              Book appointments, message your doctor, and manage your health requests.
            </p>
            <Link to="/signup" style={{ textDecoration: "none", width: "100%", marginTop: "auto" }}>
          ...
          <div style={{
            ...
            <Link to="/doctorsignup" style={{ textDecoration: "none", width: "100%", marginTop: "auto" }}>
