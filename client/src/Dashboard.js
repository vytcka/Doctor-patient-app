...
function Dashboard({ isLoggedIn, username, userData }) {
    ...
    <div style={{ backgroundColor: "#f5f7fa", minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: "420px", margin: "40px auto", backgroundColor: "white", borderRadius: "12px", padding: "40px", boxShadow: "0 4px 12px rgba(0,0,0,0.1)", textAlign: "center" }}>
        ...
        <div style={{ textAlign: "left", marginBottom: "28px" }}>
          <p style={{ marginBottom: "10px", color: "#040f25" }}><span style={{ color: "#607593" }}>Name: </span>{userData.first_name} {userData.last_name}</p>
          <p style={{ marginBottom: "10px", color: "#040f25" }}><span style={{ color: "#607593" }}>Email: </span>{userData.username}</p>
          <p style={{ marginBottom: "10px", color: "#040f25" }}><span style={{ color: "#607593" }}>Location: </span>{userData.location}</p>
          <p style={{ marginBottom: "10px", color: "#040f25" }}><span style={{ color: "#607593" }}>Member since: </span>{userData.date_of_birth}</p>
        </div>
